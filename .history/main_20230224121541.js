...
// TAMANHO DAS GOSTAS DE CHUVA - 40 = PADRAO
Rain.height = 40;
Rain.prototype.init = function() {
	this.y = Math.random() * -100;

    // VELOCIDADE DE QUEDA DA CHUVA - 0.5 + 0.5 = PADRAO
...
function Drop() {
	this.x = 0;
	this.y = 0;
	this.radius = Math.round(Math.random() * 4 + 2) * demo.dpr;
	this.speed_x = 0;
	this.speed_y = 0;
...
function clickTragedia(){
		...
		document.querySelector("button.btn-normal.active").classList.remove("active")
		document.querySelector("button.btn-tragedia.active").classList.add("active")
...
function clickNormal(){
		...
		document.querySelector("button.btn-normal.active").classList.add("active")
		document.querySelector("button.btn-tragedia.active").classList.remove("active")
